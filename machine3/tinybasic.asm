...
;
RCCHR:
         bit UART_RXSTS             ; Wait for uart_rx ready
         bpl RCCHR
         lda UART_RX                ; Get the char
         sta UART_RXSTS             ; clear the ready flag
...
GETSTS:  bit UART_TXSTS             ; bit (B7) cleared yet?
...
BREAK:   sta $FE                    ; Save A
         clc                        ; Clear carry 
         lda UART_RXSTS             ; Get keyboard status
         bpl NO_CHR                 ; Finish up if no character typed
         sec                        ; Set carry (break detected)
         lda UART_RX                ; Get the character to reset keyboard status
